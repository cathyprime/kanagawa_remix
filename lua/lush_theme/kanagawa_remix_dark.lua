...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    CmpItemKindText          { fg = Normal.fg,                bg = Normal.fg.li(10).da(44),                gui = "standout" },
    CmpItemKindMethod        { fg = sym"@method".fg,          bg = sym"@method".fg.li(10).da(44),          gui = "standout" },
    CmpItemKindFunction      { fg = Function.fg,              bg = Function.fg.li(10).da(44),              gui = "standout" },
    CmpItemKindConstructor   { fg = sym"@constructor".fg,     bg = sym"@constructor".fg.li(10).da(44),     gui = "standout" },
    CmpItemKindField         { fg = sym"@variable.member".fg, bg = sym"@variable.member".fg.li(10).da(44), gui = "standout" },
    CmpItemKindVariable      { fg = MsgArea.fg,               bg = MsgArea.fg.li(10).da(44),               gui = "standout" },
    CmpItemKindClass         { fg = Type.fg,                  bg = Type.fg.li(10).da(44),                  gui = "standout" },
    CmpItemKindInterface     { fg = Type.fg,                  bg = Type.fg.li(10).da(44),                  gui = "standout" },
    CmpItemKindModule        { fg = sym"@module".fg,          bg = sym"@module".fg.li(10).da(44),          gui = "standout" },
    CmpItemKindProperty      { fg = sym"@property".fg,        bg = sym"@property".fg.li(10).da(44),        gui = "standout" },
    CmpItemKindUnit          { fg = Number.fg,                bg = Number.fg.li(10).da(44),                gui = "standout" },
    CmpItemKindValue         { fg = String.fg,                bg = String.fg.li(10).da(44),                gui = "standout" },
    CmpItemKindEnum          { fg = Type.fg,                  bg = Type.fg.li(10).da(44),                  gui = "standout" },
    CmpItemKindKeyword       { fg = Keyword.fg,               bg = Keyword.fg.li(10).da(44),               gui = "standout" },
    CmpItemKindSnippet       { fg = Special.fg,               bg = Special.fg.li(10).da(44),               gui = "standout" },
    CmpItemKindColor         { fg = Special.fg,               bg = Special.fg.li(10).da(44),               gui = "standout" },
    CmpItemKindFile          { fg = Directory.fg,             bg = Directory.fg.li(10).da(44),             gui = "standout" },
    CmpItemKindReference     { fg = Special.fg,               bg = Special.fg.li(10).da(44),               gui = "standout" },
    CmpItemKindFolder        { fg = Directory.fg,             bg = Directory.fg.li(10).da(44),             gui = "standout" },
    CmpItemKindEnumMember    { fg = Constant.fg,              bg = Constant.fg.li(10).da(44),              gui = "standout" },
    CmpItemKindConstant      { fg = Constant.fg,              bg = Constant.fg.li(10).da(44),              gui = "standout" },
    CmpItemKindStruct        { fg = Type.fg,                  bg = Type.fg.li(10).da(44),                  gui = "standout" },
    CmpItemKindEvent         { fg = Type.fg,                  bg = Type.fg.li(10).da(44),                  gui = "standout" },
    CmpItemKindOperator      { fg = Operator.fg,              bg = Operator.fg.li(10).da(44),              gui = "standout" },
    CmpItemKindTypeParameter { fg = Type.fg,                  bg = Type.fg.li(10).da(44),                  gui = "standout" },
    CmpItemKindCopilot       { fg = String.fg,                bg = String.fg.li(10).da(44),                gui = "standout" },
