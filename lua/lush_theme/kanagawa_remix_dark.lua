...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    StatusLine     { fg = palette.fujiWhite, bg = CursorLine.bg }, -- Status line of current window
    ...
    MiniStatuslineModeVisualLine  { fg = palette.oldWhite, bg = palette.lotusOrange, gui = "bold" },
    MiniStatuslineModeVisualBlock { fg = palette.crystalBlue, bg = palette.sumiInk1, gui = "bold" },
    ...
    BlinkCmpKindTextSel          { BlinkCmpKindText },
    BlinkCmpKindMethodSel        { BlinkCmpKindMethod },
    BlinkCmpKindFunctionSel      { BlinkCmpKindFunction },
    BlinkCmpKindConstructorSel   { BlinkCmpKindConstructor },
    BlinkCmpKindFieldSel         { BlinkCmpKindField },
    BlinkCmpKindVariableSel      { BlinkCmpKindVariable },
    BlinkCmpKindClassSel         { BlinkCmpKindClass },
    BlinkCmpKindInterfaceSel     { BlinkCmpKindInterface },
    BlinkCmpKindModuleSel        { BlinkCmpKindModule },
    BlinkCmpKindPropertySel      { BlinkCmpKindProperty },
    BlinkCmpKindUnitSel          { BlinkCmpKindUnit },
    BlinkCmpKindValueSel         { BlinkCmpKindValue },
    BlinkCmpKindEnumSel          { BlinkCmpKindEnum },
    BlinkCmpKindKeywordSel       { BlinkCmpKindKeyword },
    BlinkCmpKindSnippetSel       { BlinkCmpKindSnippet },
    BlinkCmpKindColorSel         { BlinkCmpKindColor },
    BlinkCmpKindFileSel          { BlinkCmpKindFile },
    BlinkCmpKindReferenceSel     { BlinkCmpKindReference },
    BlinkCmpKindFolderSel        { BlinkCmpKindFolder },
    BlinkCmpKindEnumMemberSel    { BlinkCmpKindEnumMember },
    BlinkCmpKindConstantSel      { BlinkCmpKindConstant },
    BlinkCmpKindStructSel        { BlinkCmpKindStruct },
    BlinkCmpKindEventSel         { BlinkCmpKindEvent },
    BlinkCmpKindOperatorSel      { BlinkCmpKindOperator },
    BlinkCmpKindTypeParameterSel { BlinkCmpKindTypeParameter },
    BlinkCmpKindCopilotSel       { BlinkCmpKindCopilot },
